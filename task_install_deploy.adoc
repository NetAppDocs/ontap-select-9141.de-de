...
. Nachdem die VM bereitgestellt wurde, wählen Sie die neue VM aus. Falls sie basierend auf Ihren Eingaben im Bereitstellungsassistenten noch nicht eingeschaltet ist, schalten Sie sie manuell ein.
